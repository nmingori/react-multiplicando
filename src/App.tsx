...
import win1 from './components/images/win-1.gif';
import win2 from './components/images/win-2.gif';
import win3 from './components/images/win-3.gif';
...
const App = () => {
    ...
    useEffect(() => {
        ...
        do {
            lfNum = Math.floor(Math.random() * 9) + 1;
